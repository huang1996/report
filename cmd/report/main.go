...
func demoRows() []HostRow {
	seed := []struct {
		ip, section, proj, role, eng, os, arch string
		cores                                  float64
		...
		{"192.168.30.105", "大数据生产区", "天地图政务版", "Web前端1", "邹源", "Ubuntu 22.04", "amd64", 8, 23.1, 61.2, 46.5, 72.3, 55.1, 16, 200, 12.4, 88.3, 210.5, 432, false},
		{"192.168.30.106", "大数据生产区", "天地图政务版", "Web前端2", "邹源", "Ubuntu 22.04", "amd64", 8, 21.8, 58.7, 44.2, 70.1, 51.6, 16, 200, 10.9, 82.1, 198.3, 398, false},
		{"192.168.30.110", "大数据生产区", "天地图政务版", "应用服务器1", "邹源", "Ubuntu 22.04", "amd64", 16, 55.3, 92.4, 61.7, 84.2, 63.8, 32, 500, 31.2, 145.6, 402.1, 1205, false},
		{"192.168.30.111", "大数据生产区", "天地图政务版", "应用服务器2", "邹源", "Ubuntu 22.04", "amd64", 16, 52.9, 88.6, 59.4, 81.5, 60.2, 32, 500, 28.7, 138.9, 376.4, 1142, false},
		{"10.40.1.2", "互联网区", "智慧民政", "数据库主", "张三", "Microsoft Windows Server 2016 Standard", "amd64", 8, 34.6, 78.9, 72.8, 91.3, 86.4, 32, 1000, 45.3, 96.2, 233.8, 865, false},
		{"10.40.1.3", "互联网区", "智慧民政", "数据库备", "张三", "Microsoft Windows Server 2016 Standard", "amd64", 8, 31.2, 74.3, 70.1, 89.7, 84.9, 32, 1000, 41.8, 91.5, 221.6, 802, false},
		{"10.40.1.10", "互联网区", "智慧民政", "业务服务器1", "李四", "Ubuntu 22.04", "amd64", 4, 12.3, 45.8, 38.2, 55.6, 40.3, 8, 100, 6.2, 42.8, 120.3, 215, false},
		{"10.40.1.11", "互联网区", "智慧民政", "业务服务器2", "李四", "Ubuntu 22.04", "amd64", 4, 11.7, 44.2, 36.9, 53.8, 39.1, 8, 100, 5.8, 40.2, 115.7, 208, false},
		{"10.40.1.20", "互联网区", "智慧民政", "缓存服务器", "李四", "Ubuntu 22.04", "arm64", 8, 8.9, 22.1, 74.5, 80.2, 12.3, 16, 100, 3.1, 30.5, 88.9, 0, true},
		{"172.16.8.5", "城投集团生产区", "两江控股OA", "OA应用", "王五", "CentOS 7.9", "amd64", 4, 42.5, 96.8, 66.1, 78.4, 91.7, 8, 100, 18.6, 55.4, 165.2, 655, false},
	}
	now := time.Now()
	...
	for _, s := range seed {
		rows = append(rows, HostRow{
			...
			SampleRate: 1.0, OS: s.os, Arch: s.arch,
		})
	}
	for i := range rows {
